...
const reqCreateTable = (name,content) => `CREATE TABLE IF NOT EXISTS ${name} (${content})`
...
const main = async () => {
    ...
    const dbImages = new sqlite3.Database("./generated/images/database.db", sqlite3.OPEN_READWRITE)
